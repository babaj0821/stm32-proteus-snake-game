...
You can add screenshots of the Proteus circuit and the running game inside `docs/images/`.
...
```text
A fun STM32F401RE Snake game project simulated in Proteus using GPIO buttons and a 128x64 graphical LCD.
```
